...
*   [addSimpleSceneWithoutTable][22]
    *   [Parameters][23]
*   [addButtonToNavbar][24]
    *   [Parameters][25]
*   [addDropdownToNavbar][26]
    *   [Parameters][27]
*   [changeTextOfButton][28]
    *   [Parameters][29]
*   [changeTextOfDropdown][30]
    *   [Parameters][31]
*   [getWindowWidth][32]
*   [getWindowHeight][33]
*   [init][34]
...
*   `window` **[Window][41]** The browser window containing the Three.js canvas.
*   `camera` **THREE.PerspectiveCamera** The camera used to view the scene, typically a PerspectiveCamera.
*   `enabled` **[boolean][42]** A boolean to enable or disable automatic resizing. Defaults to true. (optional, default `true`)
...
*   `cameraDistanceThreshold` **[number][43]** The maximum distance at which to check for occlusion.
...
*   `color` **[string][44]** The color of the light, specified as a hexadecimal string.
*   `intensity` **[number][43]** The intensity of the light, typically between 0 and 1.
...
Returns **[HTMLElement][45]** The created loading screen element.
...
*   `path` **[string][44]** The path to the GLTF model file.
*   `name` **[string][44]** The name to assign to the loaded model.
*   `size` **[number][43]** The scale factor to apply to the model after loading.
*   `timeToWait` **[number][43]** The delay (in milliseconds) to wait after loading the model. (optional, default `500`)
...
*   `name` **[string][44]** The name of the model to copy.
*   `size` **[number][43]** The scale factor to apply to the copied model. (optional, default `1`)
*   `counter` **[number][43]** It can add a number to append to the copied model name. If nothing is given, it will resume its own naming. (optional, default `0`)
*   `timeToWait` **[number][43]** The delay (in milliseconds) to wait after creating the copy. (optional, default `100`)
...
*   `name` **[String][44]** The name of the model to delete

Returns **[Boolean][42]** Returns true if the copy was deleted, false otherwise.
...
Returns **[Boolean][42]** Returns true if the copies were deleted, false otherwise.
...
*   `path` **[string][44]** The path to the texture image file.
*   `repeat` **[number][43]** The number of times to repeat the texture in both directions. (optional, default `1`)
...
*   `floor` **[string][44]** The path to the texture image file for the floor. By default, it is a wood floor. (optional, default `"framework/textures/wood_floor.jpg"`)
*   `wall` **[string][44]** The path to the texture image file for the walls. By default, it is a brick wall. (optional, default `"framework/textures/wall.jpg"`)
*   `ceiling` **[string][44]** The path to the texture image file for the ceiling. By default, it is a wood ceiling. (optional, default `"framework/textures/roof.jpg"`)
...
*   `textButton` **[string][44]** The text to display on the button. (optional, default `"click me"`)
*   `onclickFunction` **[Function][46]** The function to execute when the button is clicked. (optional, default `()=>alert("click")`)
*   `hover` **[boolean][42]** A boolean to enable or disable hover effects on the button. Defaults to true. (optional, default `true`)
*   `classesOfTheButton` **[Array][47]<[string][44]>** An array of classes to apply to the button element. (optional, default `["a"]`)

Returns **[HTMLElement][45]** The created button element.
...
*   `textButton` **[string][44]** The text to display on the dropdown button. (optional, default `"DropDown"`)
*   `dropdownList` **[Array][47]<{text: [string][44], onClick: [Function][46]}>** An array of dropdown items. (optional, default `[{text:"Parameters",onClick:()=>alert("Hello!")}]`)

Returns **[HTMLElement][45]** The created dropdown button element.
...
*   `newText` **[String][44]** The text which will replace the current text of the button
...
*   `newText` **[String][44]** The text which will replace the current text of the dropdown

## getWindowWidth

Get the width of the browser window.

Returns **[number][43]** The width of the browser window in pixels.

## getWindowHeight

Get the height of the browser window.

Returns **[number][43]** The height of the browser window in pixels.

## init

Private function to initialize the scene, camera and renderer.

Returns **[Object][48]** Returns an object containing the scene, camera and renderer.
...
Returns **[boolean][42]** Returns true if the object is fully occluded, false otherwise.
...
[24]: #addbuttontonavbar

[25]: #parameters-10

[26]: #adddropdowntonavbar

[27]: #parameters-11

[28]: #changetextofbutton

[29]: #parameters-12

[30]: #changetextofdropdown
...
[41]: https://developer.mozilla.org/docs/Web/API/Window
